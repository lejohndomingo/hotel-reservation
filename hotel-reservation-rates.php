...
<?php
/**
 * Plugin Name: Hotel Reservation – Room Types, Quantity, Seasonal + Weekly/Monthly Pricing (Stripe Ready)
 * Description: Room types with quantity, seasonal pricing, weekly/monthly rates, availability checks, Stripe payments, and search/booking shortcodes.
 * Version: 1.4.0
 * Author: M365 Copilot
...
if (!defined('HRT_PLUGIN_VERSION')) define('HRT_PLUGIN_VERSION', '1.4.0');
