...
<?php
/**
 * Plugin Name: Hotel Reservation – Room Types with Quantity (Stripe Ready)
 * Description: Room types (quantity), availability checks (overlap count), Stripe card payments, and shortcodes for search & booking.
 * Version: 1.2.0
 * Author: M365 Copilot
...
// Constants
if (!defined('HRT_PLUGIN_VERSION')) define('HRT_PLUGIN_VERSION', '1.2.0');
                ...
                <div class="hrt-type" data-room-type-id="<?php echo esc_attr(get_the_ID()); ?>">
                    ...
                    <div class="hrt-type-body">
                        ...
                        <div class="hrt-type-meta">
                            <span class="hrt-price"><?php echo esc_html(hrt_format_price($price)); ?> / <?php esc_html_e('night', 'hotel-reservation-lite'); ?></span>
